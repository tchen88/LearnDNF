		...
		for correlation in correlations:
			for error in errors:
				for diff_method in diff_methods:
					for hypothesis, hypothesis_abbrev in zip(initial_hypotheses, ['1', 't']):
						for index in range(100):
							infile = open('outputs/special{0}T{1}V{2}C{3}M{4}H{5:d}_{6}e.txt'.format(
